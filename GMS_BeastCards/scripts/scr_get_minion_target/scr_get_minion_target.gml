...
//           Randomly selects among multiple Focused targets.
//           Falls back to a random living enemy when no Focus exists.
//
//===============================================================================//
function scr_get_minion_target(_list_enemy,_ref_exclude=undefined){
	...
	for (var _it_enemy = 0; _it_enemy < ds_list_size(_list_enemy); _it_enemy++){
		...
		//CHECK FOCUS//
		//-------------//
		if (scr_check_for_status("FOCUS",_ref_enemy) != -1){
