//===============================================================================//
//
// SCRIPT: SCR_BATTLE_TRIGGER_METABOLIZE
// FUNCTION: Resolves the Viridian METABOLIZE mechanic.
...
function scr_battle_trigger_metabolize(_ref_target,_ct_poison_amount=undefined){
