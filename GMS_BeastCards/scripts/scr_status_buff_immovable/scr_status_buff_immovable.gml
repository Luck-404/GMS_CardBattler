...
function scr_status_buff_immovable(_str_tag,_ref_status,_val_magnitude=undefined,_val_lifetime=undefined){
	...
	switch (_str_tag){
		...
		case "APPLY":
			...
			//CHECK EXISTING//
			//----------------//
			var _ref_existing_status = scr_status_check("IMMOVABLE",_ref_target);
			...
			//STATUS DATA//
			//-------------//
			_ref_new_status._scr_status = scr_status_buff_immovable;

			_ref_new_status._ref_host = _ref_target;

			_ref_new_status._str_status_type = "BUFF";
			_ref_new_status._str_status_name = "IMMOVABLE";
			_ref_new_status._str_status_desc = "CANNOT BE REPOSITIONED";

			_ref_new_status._spr_status = spr_status_buff_immovable;
