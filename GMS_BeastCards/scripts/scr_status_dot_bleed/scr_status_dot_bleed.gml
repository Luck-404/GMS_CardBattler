...
//           Applies or stacks Bleed on the target beast.
//           Deals stack-based damage at turn start and removes itself on death.
//
//===============================================================================//
function scr_status_dot_bleed(_str_tag,_ref_status){
	...
	switch(_str_tag){
		...
		case "APPLY":
			...
			var _ref_existing_status = scr_check_for_status("BLEED",_ref_target);
			...
			_ref_new_status._str_status_desc = "BLEEDING";
