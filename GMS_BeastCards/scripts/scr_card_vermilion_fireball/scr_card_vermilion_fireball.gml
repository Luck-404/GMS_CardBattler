//===============================================================================//
//
// SCRIPT: SCR_CARD_VERMILION_FIREBALL
// FUNCTION: Resolves Fireball.
//           Deals linear Magical damage to every living Beast
...
function scr_card_vermilion_fireball(_stct_card,_ref_caster,_ref_target){
