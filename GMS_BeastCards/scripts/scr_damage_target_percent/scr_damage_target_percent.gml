//===============================================================================//
//
// SCRIPT: SCR_DAMAGE_TARGET_PERCENT
...
function scr_damage_target_percent(_val_damage_percent,_ref_target,_stct_presentation=undefined){
...
if (_ref_target._ct_dodge_disabled <= 0){
	...
	if (
		...
		var _val_overhealth_blocked = min(
