...
// RETURNS: The active Vulnerable Status on APPLY; otherwise undefined.
//
//===============================================================================//
...
function scr_status_debuff_vulnerable(_str_tag,_ref_status,_val_lifetime=undefined){
	...
	switch (_str_tag){
		...
		case "APPLY":
			...
			//CHECK EXISTING//
			//----------------//
			var _ref_existing_status = scr_status_check("VULNERABLE",_ref_target);
			...
			//=========================//
			_ref_target._val_dmg_taken_scalar_bonus += _ref_new_status._val_status_magnitude;
		...
		case "DEATH":
			...
			//=======================//
			if (instance_exists(_ref_host)){
				_ref_host._val_dmg_taken_scalar_bonus -= _ref_status._val_status_magnitude;
			}
