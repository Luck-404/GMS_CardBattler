...
function scr_armor_target_linear(_val_amount,_ref_target){
	...
	var _str_card_stat = _ref_card._ref_card._str_card_stat;
	...
	if (_str_card_stat == "PHY"){
		...
		var _val_ppow_stat = _ref_caster._ref_unit._val_beast_ppow_stat;
		var _val_ppow_mod = scr_get_beast_grade_modifier(_val_ppow_stat);

		_val_armor = ceil(_val_armor * _val_ppow_mod);
	}
	...
	//----------------//
		...
		_val_armor = ceil(_val_armor * _val_mpow_mod);
	}

	//-------------//
	//GRANT ARMOR//
	//-------------//
	scr_armor_target(_val_armor,_ref_target);
