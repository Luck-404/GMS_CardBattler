//===============================================================================//
//
// SCRIPT: SCR_CARD_VIRIDIAN_BIOSTORM
// FUNCTION: Resolves the Biostorm card effect.
//           Deals percentage-based magical damage to every living Beast
//           on the selected target's team.
//
//===============================================================================//

function scr_card_viridian_biostorm(_stct_card,_ref_caster,_ref_target){
