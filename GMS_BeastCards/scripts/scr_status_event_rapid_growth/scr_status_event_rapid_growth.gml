//===============================================================================//
//
// SCRIPT: SCR_STATUS_EVENT_RAPID_GROWTH
// FUNCTION: Handles the Rapid Growth global Weather status.
//           Unstackable Timed.
//           Grants +25% Viridian damage while active.
//           At the end of each round, selects two random living Beasts,
//           heals each for 1, and summons a random Viridian Minion on each.
//
//===============================================================================//
function scr_status_event_rapid_growth(_str_tag,_ref_status,_val_lifetime=undefined){
