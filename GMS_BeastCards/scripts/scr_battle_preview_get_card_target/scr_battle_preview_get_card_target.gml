//===============================================================================//
//
// SCRIPT: scr_battle_preview_get_card_target
...
function scr_battle_preview_get_card_target(_stct_card,_ref_target){
	...
	if (
		...
		return "CON " + scr_battle_preview_get_stats(
	...
	if (
		...
		return "PDEF " + scr_battle_preview_get_stats(
	...
	if (
		...
		return "MDEF " + scr_battle_preview_get_stats(
