...
//===============================================================================//
//
// SCRIPT: SCR_STATUS_DEBUFF_MOLTEN_BRAND
// FUNCTION: Handles Molten Brand.
//           Unstackable Timed Debuff.
//           Increases damage received from Vermilion Cards by 25% by default.
...
function scr_status_debuff_molten_brand(_str_tag,_ref_status,_val_lifetime=undefined,_val_magnitude=undefined,_ref_target=undefined){
	...
	switch (_str_tag){
		...
		case "APPLY":
			...
			//STATUS DATA//
			//=============//
			_ref_new_status._scr_status = scr_status_debuff_molten_brand;

			_ref_new_status._ref_host = _ref_target;

			_ref_new_status._str_status_type = "DEBUFF";
			_ref_new_status._str_status_name = "MOLTEN_BRAND";
			...
			_ref_new_status._spr_status = spr_status_debuff_molten_brand;
