//===============================================================================//
//
// SCRIPT: SCR_BATTLE_DAMAGE_TARGET_ARMOR_PIERCE
// FUNCTION: Deals Armor-piercing direct damage to a target battle Beast.
//           Resolves Dodge, protection, color/critical bonuses, damage modifiers,
//           Power scaling, Defense mitigation, Minions, HP, held items,
//           reactive statuses, and post-damage triggers.
//           Bypasses both Armor and Overhealth before damaging HP.
//
...
function scr_battle_damage_target_armor_pierce(_val_damage,_ref_target,_stct_presentation=undefined){
	...
	//--------------------//
	if (_val_hp_damage > 0){
		scr_status_trigger_damage_auras(_ref_target,_val_hp_damage);
	}
