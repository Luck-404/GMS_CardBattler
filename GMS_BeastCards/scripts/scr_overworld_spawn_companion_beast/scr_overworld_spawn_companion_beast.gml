function scr_spawn_player_follow_beast(){
	...
	var _ref_beast = instance_create_layer(obj_player.x,obj_player.y + 32,"ily_npcs",obj_overworld_beast);

	_ref_beast._str_team = "PLAYER";
	_ref_beast._ref_unit = _ref_unit;
	_ref_beast._spr_shadow = scr_beast_get_type_shadow(_ref_unit._str_beast_color_type);
