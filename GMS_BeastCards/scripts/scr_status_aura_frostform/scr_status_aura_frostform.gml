...
//           Generic form drawing handles the Frostform Beast recolor.
//
//===============================================================================//

function scr_status_aura_frostform(
	_str_tag,
	_ref_status,
	...
	switch(_str_tag){
		...
		case "APPLY":
			...
			_ref_new_status._str_status_desc =
				"CONSIDERED FROZEN; DAMAGE +50%; DAMAGE TAKEN +50%; ATTACKS APPLY FROSTBURN";

			_ref_new_status._spr_status =
				spr_status_aura_frostform;
