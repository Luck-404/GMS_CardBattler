...
//           Applies or stacks Poison on the target battle beast.
//           Deals base damage plus one additional damage per stack.
//
//===============================================================================//
...
function scr_status_dot_poison(_str_tag,_ref_status){
	...
	switch(_str_tag){
		...
		case "REPEAT":
			...
			var _val_damage = ceil(_ct_poison_stacks * ((5 - _val_poison_life) / 5));
