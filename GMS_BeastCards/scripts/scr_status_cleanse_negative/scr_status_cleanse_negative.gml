...
//
// ARGUMENTS: _ref_target is the Beast being cleansed and _ct_amount is the
//            maximum number of negative Statuses to remove.
// RETURNS: The number of negative Statuses successfully removed.
//
//===============================================================================//
...
function scr_status_cleanse_negative(_ref_target,_ct_amount){
	...
	while (_ct_removed < _ct_amount){
		...
		var _str_status_type = _ref_status_cleanse._str_status_type;
