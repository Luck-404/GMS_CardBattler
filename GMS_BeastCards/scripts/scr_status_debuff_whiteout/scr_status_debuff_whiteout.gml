...
//           All card casts have a 33% chance to whiff by default.
...
function scr_status_debuff_whiteout(_str_tag,_ref_status,_val_lifetime=undefined,_val_magnitude=undefined,_ref_target=undefined){
