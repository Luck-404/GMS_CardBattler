...
if (_ref_unit != undefined && _spr_shadow != undefined){
	...
	if (_str_team == "WILD"){
		...
		switch(_str_disposition){
			case "ANGRY":  _spr_fog = spr_overworld_vfx_wild_fog_angry;  break;
			case "SCARED": _spr_fog = spr_overworld_vfx_wild_fog_scared; break;
			case "CHILL":  _spr_fog = spr_overworld_vfx_wild_fog_chill;  break;
		}
