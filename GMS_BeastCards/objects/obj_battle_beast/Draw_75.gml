...
if (_flag_preview_beast && _stct_unit != undefined){
	...
	draw_text(_val_text_x,_val_text_y,string(_stct_unit.beast_name));
	...
	var _val_hp = _stct_unit.beast_hp_stat;
	var _val_con = _stct_unit.beast_con_stat;
	var _val_ppow = _stct_unit.beast_ppow_stat;
	var _val_mpow = _stct_unit.beast_mpow_stat;
	var _val_pdef = _stct_unit.beast_pdef_stat;
	var _val_mdef = _stct_unit.beast_mdef_stat;
	var _val_crit = _stct_unit.beast_crit_stat;
	var _val_dodge = _stct_unit.beast_dod_stat;
	var _val_minions = _stct_unit.beast_min_stat;
	...
	draw_text_ext(_val_text_x,_val_text_y,string(_stct_unit.beast_ability),-1,320);
	...
	var _arr_trees = _stct_unit.beast_talent_trees;
	var _str_tree_text = "";
