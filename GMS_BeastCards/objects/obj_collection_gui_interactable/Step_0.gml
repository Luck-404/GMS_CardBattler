//
//
// STEP: OBJ_COLLECTION_GUI_INTERACTABLE | WHEN CLOSE TO PLAYER HIGHLIGHT AND ALLOW CLICK TO SUMMON THE GUI PANE
//
//
...
if (distance_to_object(obj_player) < 48 && global.pause == false){
    ...
    if (!_flag_triggered && _cooldown == 0){
        if (keyboard_check(ord("E"))){
			...
			//SPAWN NEW GUI
            var _collection_gui = instance_create_layer(room_width/2,room_height/2,"ily_fx",obj_collection_gui_pane);
