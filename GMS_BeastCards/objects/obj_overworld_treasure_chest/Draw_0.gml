...
//DRAW//
//----//
draw_sprite_ext(spr_overworld_decor_shadow, image_index, x, y, 0.3, 0.3, 0, _c_chest, 1);
draw_sprite_ext(spr_overworld_treasure_chest, image_index, x, y, 1, 1, 0, _c_chest, 1);
...
else
{
	...
	{
		draw_sprite(spr_overworld_treasure_chest_highlight,0,x,y);
		...
		{
			_val_nearby_sound_instance = audio_play_sound(snd_overworld_treasure_nearby,2,true);
		}
		...
		if (keyboard_check_pressed(ord("E")))
		{
			...
			audio_play_sound(snd_overworld_treasure_chest_open,2,false);
