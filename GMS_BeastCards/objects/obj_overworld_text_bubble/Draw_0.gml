//===============================================================================//
//
// DRAW: OBJ_OVERWORLD_TEXT_BUBBLE
// FUNCTION: Draws a padded world-space text bubble.
//           Counts down its lifespan and destroys itself when expired.
//           Destroys itself early if the player moves too far away.
//
//===============================================================================//
...
if (_str_text != "DEFAULT"){
	...
	var _val_left = x - (_val_text_w / 2) - _val_padding;
	var _val_right = x + (_val_text_w / 2) + _val_padding;
	var _val_top = y - _val_padding;
	var _val_bottom = y + _val_text_h + _val_padding;
