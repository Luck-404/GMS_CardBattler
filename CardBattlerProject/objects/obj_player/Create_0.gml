...
// CAMERA //
////////////
_camera = camera_create(); // Create a camera
_cam_width = 960; // Camera width (match your viewport)
_cam_height = 540; // Camera height (match your viewport)
camera_set_view_size(_camera, _cam_width, _cam_height); // Set camera size
camera_set_view_pos(_camera, x - _cam_width / 2, y - _cam_height / 2); // Center on character
view_set_camera(0, _camera); // Attach camera to Viewport 0
