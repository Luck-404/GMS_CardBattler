...
//////////////////////////////////////////////////////////////////////
function scr_create_combat_minion(_card,_channel,_target,_minion_type){
	...
	switch(_minion_type){
		case "Life Spirit":
			_new_minion = scr_create_minion(7,0,"Green",_minion_type,_target._creature_team,["Minion Step","None","None"],spr_minion_life_spirit,snd_creature_wraith_hurt,snd_creature_wraith_death,snd_creature_wraith_default,_target,scr_minion_life_spirit_tick,0,"Support");
		break;
		
		case "Bramblet":
			_new_minion = scr_create_minion(13,2,"Green","Bramblet",_target._creature_team,["Minion Step","Host Damage Taken","None"],spr_minion_bramblet,snd_creature_wraith_hurt,snd_creature_wraith_death,snd_creature_wraith_default,_target,scr_minion_bramblet_tick,0,"Guardian");
		break;
		
		case "Bloodbeak":
			_new_minion = scr_create_minion(7,0,"Green","Bloodbeak",_target._creature_team,["None","None","Host Damage Dealt"],spr_minion_bloodbeak,snd_creature_wraith_hurt,snd_creature_wraith_death,snd_creature_wraith_default,_target,undefined,0,"Vanguard");
		break;		

		case "Serpent":
			_new_minion = scr_create_minion(7,0,"Green","Serpent",_target._creature_team,["None","Host Damage Taken","Host Damage Dealt"],spr_minion_coiled_serpent,snd_creature_wraith_hurt,snd_creature_wraith_death,snd_creature_wraith_default,_target,undefined,0,"Vanguard");
		break;		
