...
function scr_card_life_spirit(_card,_channel,_target){
	...
	_ref_minion._minion_hp_cur = 3;
	_ref_minion._minion_hp_max = 3;
	_ref_minion._minion_def = 0;
	_ref_minion._minion_name = "Life Spirit";
	_ref_minion._minion_team = _target._creature_team;
	_ref_minion._minion_cast_types = ["Minion Step","None","None"];
	_ref_minion._minion_sprite = spr_minion_life_spirit;
	...
	_ref_minion._minion_effect_script = scr_minion_life_spirit_tick;
