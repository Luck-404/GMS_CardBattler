...
function scr_status_bleed_tick(_counter,_target,_repeat){ 	//EFFECTED BY STACKS 	//DEFAULT LIFETIME: 3
	...
	if (_repeat == true){
		...
		scr_create_combat_effect(_target,spr_effect_dripping,0,0,36,c_red,0.25,0.25,undefined,undefined,undefined,undefined,undefined,"Stationary",undefined,"Effects");	
	}
