...
//////////////////////////////////////////////////////////////////////
function scr_card_health_berry_tick(_counter,_target,_repeat){		//STACKLESS		//DEFAULT LIFETIME: 3
	...
	/////////////////	
		...
		scr_create_combat_popup(_target,"Health Berry wore off","Default",0,0);
